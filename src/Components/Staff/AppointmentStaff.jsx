              ...
              <div className="sidebar-body">
                <ul className="nav n">
                  <li className="nav-item n-t">
                    <Link className="nav-link n-l" to="/staff-dashboard">
                      Dashboard
                    </Link>
                  </li>
                  <li className="nav-item n-t">
                    <Link className="nav-link n-l" to="/staff-appointments">
                      Appointments
                    </Link>
                  </li>
                  <li className="nav-item n-t">
                    <Link className="nav-link n-l" to="/staff-customer">
                      Customer
                    </Link>
                  </li>
                  <li className="nav-item n-t">
                    <Link className="nav-link n-l" to="/staff-payment">
                      Payment
                    </Link>
                  </li>
                  <li className="nav-item n-t">
                    <Link className="nav-link n-l" to="/staff-profile">
                      My Profile
                    </Link>
                  </li>
                </ul>
